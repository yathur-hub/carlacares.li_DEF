        ...
        <ScrollReveal duration={850}>
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-8">
              ...
              <p className="text-lg text-textDark/70 leading-relaxed">
                Die abrechnungsfähigen Leistungen der ambulanten psychiatrischen Pflege sind klar definiert. Der konkrees Umfang richtet sich stets nach dem individuellen Bedarf und der ärztlichen Anordnung.
              </p>
            ...
            <div className="space-y-4">
               {[
                 ...
                 <div key={i} className="flex gap-6 p-8 bg-white rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all group duration-300">
                    <div className="w-12 h-12 bg-accentGreen/5 rounded-full flex items-center justify-center text-accentGreen flex-shrink-0 group-hover:bg-accentGreen group-hover:text-white transition-colors duration-300">
        ...
        <ScrollReveal duration={800}>
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="pt-8">
              <Link 
                to="/kontakt" 
                className="inline-block bg-accentGreen text-white px-10 py-5 rounded-2xl font-bold hover:bg-accentBrown transition-all shadow-xl text-center"
              >
