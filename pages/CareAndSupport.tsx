        ...
        <ScrollReveal duration={800}>
          <div className="max-w-7xl mx-auto space-y-16">
            <div className="text-center space-y-4">
              ...
              <p className="text-lg text-textDark/60 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                { title: "Individuell", desc: "Bedarf wird individuell und gemeinsam geklärt." }
              ].map((item, i) => (
                <div key={i} className="p-8 bg-secondary/30 rounded-3xl border border-gray-100 hover:shadow-lg transition-all duration-300">
