      ...
      <section className="py-20 px-6 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
            ...
            <Link
              to="/angebot"
              className="bg-secondary/30 hover:bg-secondary/50 p-8 md:p-12 rounded-[40px] border border-gray-100/60 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group cursor-pointer text-left focus:outline-none focus:ring-2 focus:ring-accentBrown/20"
            >
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Teaser 1: Angebot */}
            <div className="bg-secondary/30 p-8 rounded-[40px] border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col justify-between group">
              <div className="space-y-6">
            ...
            {/* Teaser 4: Abrechnung */}
            <div className="bg-secondary/30 p-8 rounded-[40px] border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col justify-between group md:col-span-1">
              <div className="space-y-6">
                <div className="w-12 h-12 bg-accentGreen/10 rounded-2xl flex items-center justify-center text-accentGreen">
            ...
            <div className="bg-accentGreen text-white p-8 rounded-[40px] shadow-xl hover:shadow-accentGreen/20 transition-all duration-300 flex flex-col justify-between group md:col-span-2">
              <div className="space-y-6">
