        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold text-accentGreen tracking-tight group-hover:text-accentBrown transition-colors">CarlaCares</span>
          ...
          <div className="space-y-6">
            ...
            <nav className="flex flex-col space-y-3">
              <Link to="/angebot" className="text-[14px] text-textDark/70 hover:text-accentGreen transition-colors flex items-center group">
                <span className="w-1.5 h-1.5 rounded-full bg-accentBrown/30 mr-3 group-hover:bg-accentBrown transition-colors"></span>
                Pflege & Begleitung
              </Link>
              <Link to="/abrechnung" className="text-[14px] text-textDark/70 hover:text-accentGreen transition-colors flex items-center group">
                <span className="w-1.5 h-1.5 rounded-full bg-accentBrown/30 mr-3 group-hover:bg-accentBrown transition-colors"></span>
                Abrechnung & Kosten
              </Link>
              <Link to="/ueber-mich" className="text-[14px] text-textDark/70 hover:text-accentGreen transition-colors flex items-center group">
                <span className="w-1.5 h-1.5 rounded-full bg-accentBrown/30 mr-3 group-hover:bg-accentBrown transition-colors"></span>
                Über uns
              </Link>
            </nav>
          ...
          <div className="space-y-6">
            ...
            <nav className="flex flex-col space-y-3">
              <Link to="/zuweisende" className="text-[14px] text-textDark/70 hover:text-accentGreen transition-colors flex items-center group font-bold">
        ...
        <div className="pt-10 border-t border-gray-50 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center space-x-6">
            <nav className="flex space-x-6 text-[10px] font-black uppercase tracking-widest text-textDark/30">
              <Link to="/impressum" className="hover:text-accentBrown transition-colors">Impressum</Link>
              <Link to="/datenschutz" className="hover:text-accentBrown transition-colors">Datenschutz</Link>
            </nav>
